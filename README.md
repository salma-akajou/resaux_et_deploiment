...
- Atelier : LAN (À faire)  
- Live coding (Phase d'évaluation : N2 - Adapter)  
- Réalisation et présentation (Phase d'évaluation : N3 - Transposer)  
- Tutoriel : Outils réseau  

---

## 📂 Code source

Lien GitHub du projet : `https://github.com/salma-akajou/resaux_et_deploiment`
